<?php
    ...
    SELECT 
        ...
        s.supplier_name
    FROM 
        handle_defective_product_history hdph
    JOIN 
        products p ON hdph.product_id = p.product_id
    JOIN 
        users u ON hdph.Id = u.Id
    JOIN 
        suppliers s ON hdph.supplier_id = s.supplier_id
    ORDER BY 
        hdph.date_time DESC
    ";
...
<div class="pill-nav">
  ...
  <a class="active" href="defective_history.php">Defective</a>
